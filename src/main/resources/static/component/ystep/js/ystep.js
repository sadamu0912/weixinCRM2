  ...
  $.fn.extend({
    ...
    loadStep: function(params){
      ...
      var stepHtml = "<li class='ystep-step ystep-step-undone' data-container='body' data-toggle='popover' data-placement='top' data-title='' data-content='' data-trigger='hover'>"+
                     "</li>";
      var stepButtonHtml = "<div class='step-button'><button type='button' class='btn btn-default prevBtn'>上一步</button>"+
      ...
      $(this).each(function(i,n){
        ...
        $(".prevBtn").click(function(){
          $(this).parent().parent().parent().parent().prevStep();
        });
        $(".nextBtn").click(function(){
          $(this).parent().parent().parent().parent().nextStep();
        });

        //绑定步骤点击
        $(".ystep-container-steps li").click(function(){
          var stepnum = $(this).index() + 1;
          $(this).parent().parent().parent().setStep(stepnum);
        });
    ...
    setStep: function(step) {
      $(this).each(function(i,n){
        //获取当前容器下所有的步骤
        var $steps = $(this).find(".ystep-container").find("li");
        var $progress =$(this).find(".ystep-container").find(".ystep-progress-highlight");
        //判断当前步骤是否在范围内
